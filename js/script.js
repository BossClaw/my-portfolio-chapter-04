...
// MODE TOGGLE
const mode_toggle_butt = document.querySelector('#mode_toggle');
const mode_toggle_sun = document.querySelector('#toggle_sun');
const mode_toggle_moon = document.querySelector('#toggle_moon');
const parallax = document.querySelector('#parallax_container');

mode_toggle_butt.addEventListener('click', () => {
	console.log('MODE TOGGLE');
	document.body.classList.toggle('dark');
    parallax.classList.toggle('dark');
    
	// SUN/MOON
    mode_toggle_sun.classList.toggle('mode_hidden');
    mode_toggle_moon.classList.toggle('mode_hidden');
});
